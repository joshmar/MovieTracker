...
public sealed class EpisodeType : ObjectGraphType<Episode>
{
    public EpisodeType()
    {
        ...
        Field(episode => episode.Watched, nullable: false).Description("Field to track if you've watched the episode or not. By default, false.");
        ...
        Field(episode => episode.Description, nullable: true).Description("An optional description to be given to the episode.");
        Field(episode => episode.Score, nullable: true).Description("An optional score to be given to the episode.");
